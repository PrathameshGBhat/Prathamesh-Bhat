...
const Hero = () => {
  ...
  const fullText = "Hi, I'm Prathamesh Bhat – a Backend Developer passionate about building scalable microservices and secure RESTful applications.";
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-32 right-16 w-16 h-16 border border-neon-purple/30 rounded-lg animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/2 right-20 w-12 h-12 border border-neon-cyan/30 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="w-40 h-40 mx-auto rounded-full bg-gradient-to-r from-electric-blue to-neon-purple p-1 animate-glow-pulse">
              <div className="w-full h-full rounded-full bg-dark-card flex items-center justify-center">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
                  <span className="text-4xl font-bold text-electric-blue">PB</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Skills Highlight */}
          <div className="mb-12">
            <p className="text-electric-blue text-sm uppercase tracking-wider mb-4 font-semibold">Primary Skills</p>
            <div className="flex flex-wrap justify-center gap-4">
              {['Java', 'Spring Boot', 'MERN', 'REST APIs', 'SQL', 'C++'].map((skill, index) => (
                <span
                  key={skill}
